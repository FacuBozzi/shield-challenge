...
Backend API for authenticating users and managing their wallets. Built with Express, TypeScript, Prisma, Zod, Docker and PostgreSQL.
...
### OpenAPI, Postman & Manual Testing
